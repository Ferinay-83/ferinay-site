...
export async function POST(request: NextRequest) {
  try {
    ...
    const { firstName, lastName, email, phone, company, message, privacyConsent } = body
    ...
    try {
      ...
      if (!autoResponderResponse.ok) {
        console.error("Failed to send auto-responder email:", await autoResponderResponse.text())
      }
    } catch (emailError) {
